...
import { SESSION_COOKIE, audit, createSession, destroySession, requireAuth, setSessionCookie, userFromRequest, } from '../security/auth.js';
...
authRouter.post('/login', loginLimiter, async (req, res) => {
    ...
    const row = db.prepare('SELECT id, username, password_hash FROM users WHERE username = ?').get(body.username);
