...
function parseFilter(q: Record<string, unknown>, prefix = ''): analysis.CorpusFilter {
...
corpusRouter.get('/info', (_req, res) =>
  res.json({ ...corpusInfo(), defaultUrl: config.corpusDefaultUrl, sections: ILLUSTRATION_LABELS }),
);
